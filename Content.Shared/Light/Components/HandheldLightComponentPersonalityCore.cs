...
public sealed partial class HandheldLightPersonalityCoreComponent : Component
{
    public byte? Level;
    ...
    public string ToggleAction = "ActionToggleLightPersonalityCore"; ///EPICCHANGE WHY WONT IT USE THIS ONE INSTEAD OF REGULAR ONE
    ...
    public sealed class HandheldLightComponentPersonalityCoreState : ComponentState
    {
        public byte? Charge { get; }

        public bool Activated { get; }

        public HandheldLightComponentPersonalityCoreState(bool activated, byte? charge)
        {
            Activated = activated;
            Charge = charge;
        }
...
[Serializable, NetSerializable]
public enum HandheldLightPersonalityCoreVisuals
{
    Power
}

[Serializable, NetSerializable]
public enum HandheldLightPowerPersonalityCoreStates
{
    FullPower,
    LowPower,
    Dying,
